...
public final class UserResponseDTO {
    ...
    public record Summary(
            ...
            @Schema(description = "Full name of the user", example = "Gaurav Taneja")
            String fullName,

            @Schema(description = "Email address of the user", example = "gaurav.t@gmail.com")
            String email,
            ...
            @Schema(description = "City where the user is located", example = "Mumbai")
            String city,
